 ...
 */
public class BenchFastECElGamal extends InstrumentationTestCase {
    ...
    private static final String TEST_NAME = "BenchFastECElGamal";
    ...
    public void setUp() throws Exception {
        ...
        gamal = new FastECElGamal(FastECElGamal.generateKeys(rand), rand);
        long before = Debug.getNativeHeapAllocatedSize();
        parttestECElgamal();
        long after = Debug.getNativeHeapAllocatedSize();
        log("TableSize: " + String.valueOf(after-before));
        parttestECElgamal();
    }
    ...
    public void tearDown() throws Exception {
        ...
        FileUtil fu = new FileUtil(TEST_NAME+"2^20_1" + ".csv");
