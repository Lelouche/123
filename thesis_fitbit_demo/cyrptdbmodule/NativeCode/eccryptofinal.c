...
void setTestCurve() {
	...
	ctx = BN_CTX_new();
	a=NULL; b=NULL; p=NULL; x=NULL; y=NULL;
	BN_dec2bn(&p, pS);
	BN_dec2bn(&a, aS);
	BN_dec2bn(&b, bS);
	BN_dec2bn(&x, xS);
...
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_getNextBSGSStorageItem(JNIEnv* env, jobject javaThis) {
	BN_CTX *ctx;
	jstring resTemp;
	if(itBSGSstorage==NULL) {
		...
		ctx = BN_CTX_new();
		EC_POINT_add(curveGroup,pointBSGSstorage, pointBSGSstorage, EC_GROUP_get0_generator(curveGroup), ctx);
...
void Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_setUPBSGS(JNIEnv* env, jobject javaThis,jstring size, jstring invsize) {
	BIGNUM *temp;
	//set Params
	/*if(m!=NULL) {
...
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_computeBsGsStep(JNIEnv* env, jobject javaThis, jstring M) {
	const char* cMStr;
	jstring res;
	char* resC;
	BN_CTX *ctx;
...
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_computeBsGsStepNeg(JNIEnv* env, jobject javaThis, jstring M) {
	const char* cMStr;
	jstring res;
	char* resC;
	BN_CTX *ctx;
...
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_computeBsGsResult(JNIEnv* env, jobject javaThis, jstring value) {
	...
	BN_CTX_free(ctx);
	BN_free(it); BN_free(resMap); BN_free(mul);
...
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_computeBsGsResultNeg(JNIEnv* env, jobject javaThis, jstring value) {
	BIGNUM * it,*resMap, *mul;
	jstring result;
	BN_CTX *ctx;
	if(NegBsGsStep == NULL) {
 ...
 */
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_encryptNative(JNIEnv* env,
 ...
 */
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_decryptNative(JNIEnv* env, jobject javaThis,jstring cipher,jstring secret) {
	EC_POINT *R,*S,*temp,*M;
	BIGNUM *secretB;
	BN_CTX *ctx;
	jstring res;
...
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_addCipherNative(JNIEnv* env, jobject javaThis,jstring cipher1,jstring cipher2) {
...
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_computePubKey(JNIEnv* env, jobject javaThis, jstring secret) {
	BIGNUM *secretB;
	jstring res;
	EC_POINT *pubKey;
	char *strY;
 ...
 */
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_getCurveOrder(JNIEnv* env, jobject javaThis) {
	BIGNUM *order;
	jstring res;
	BN_CTX *ctx;
 ...
 */
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_getPrimeOfGf(JNIEnv* env, jobject javaThis) {
	BIGNUM *prime;
	jstring res;
 ...
 */
void Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_tearDOWN(JNIEnv* env, jobject javaThis) {
 ...
 * 0 -> default NIST-p192
 */
void Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_setUP(JNIEnv* env, jobject javaThis,jint curveNr) {
	if(curveNr==0) {
 ...
 */
jstring Java_ch_ethz_inf_vs_lubu_cyrptdbmodule_cryptoalg_NativeECElGamal_computeGenTimes(JNIEnv* env, jobject javaThis, jstring num) {
		EC_POINT *point;
		BIGNUM *numB,*res;
		char* temp;
		jstring returnVal;
